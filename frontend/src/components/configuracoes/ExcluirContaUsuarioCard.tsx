  ...
  return (
    <Card className="p-4">
      <div className="flex items-center gap-3">
        <span className="grid size-8 shrink-0 place-items-center rounded-[10px] bg-destructive/10 text-destructive">
          <AlertTriangle className="size-4" />
        </span>
        <h3 className="font-display text-sm font-bold text-foreground">Excluir conta</h3>
      </div>
      <p className="mt-2.5 text-xs leading-relaxed text-muted-foreground">
        Exclui permanentemente sua conta e todos os dados vinculados. Essa ação não
        pode ser desfeita.
      </p>
      <Button
        variant="destructive"
