# Resultado — migração de categorias sem grupo (esteyceecassio@gmail.com)

Execução real no banco de produção (Supabase), gerada a partir de `backend/prisma/migrar-categorias-sem-grupo.ts esteyceecassio@gmail.com`. Para cada categoria sem grupo com **exatamente uma** categoria equivalente com grupo (mesmo nome, mesmo espaço), as transações vinculadas foram reatribuídas para a categoria com grupo e a categoria sem grupo foi excluída.

## Resumo

- Categorias migradas e excluídas: **91**
- Transações reatribuídas (total): **5698**
- Puladas por equivalência ambígua (2+ candidatos, revisão manual): **2**
- Puladas por não ter equivalente (mantidas como estavam): **34**
- Falhas durante a migração: **0**

## ⚠️ Equivalência ambígua — não migradas, revisar manualmente

Havia mais de uma categoria com grupo com o mesmo nome, então o script não escolheu automaticamente para evitar reclassificar para a categoria errada.

| Categoria (sem grupo) | ID | Candidatos encontrados |
|---|---|---:|
| Aluguel Denise | `316e4a45-0b29-4b56-829f-c08232a2f502` | 2 |
| Presente | `3ab71579-ef91-40e9-8051-c95485feefd9` | 2 |

## ✅ Migradas e excluídas

| Categoria (sem grupo, excluída) | ID origem | Transações migradas | Grupo destino | Categoria destino (ID) |
|---|---|---:|---|---|
...
## Sem equivalente — mantidas sem alteração

Não têm categoria homônima com grupo neste espaço, então **não foram tocadas**. Continuam sem grupo, com suas transações originais.

| Categoria | ID |
|---|---|
| AP SV Amoaras | `4427d334-0cd9-4cf6-af0a-5eb33af17e23` |
| AP SV Denise | `21cfc4b1-74d2-4ff4-bdfb-fe5a61380529` |
| AP SV MarAmor | `18efe13a-379c-478d-bc75-f5692a7e47e2` |
| Apto Denise | `81440c43-c54f-4248-b558-52d0460c333c` |
| Assinaturas | `0a715e5d-01ba-407c-94fd-d679ae3748c1` |
| Cachorras | `4c8f2d02-6aad-4224-968a-879db611213a` |
| Celulares | `95a362c8-473f-4ba7-9ae8-b2707756816a` |
| ECONOMIA | `1e197685-7dd5-480d-9409-b992fdbdb447` |
| Ed. Denise (Airbnb) | `689e34ff-2f0d-47e6-bcd9-82f5cc7a704d` |
| Educação | `ebc001b6-6794-494e-bc96-aee9fac1fa66` |
| Estorno | `17022f62-154f-4808-be5e-26a0a6345dc5` |
| Estética (Filhos) | `07972168-a04f-4f7a-ad8f-e216ffc06fb2` |
| Fármacia (Filhos) | `0c768be7-da42-4f6b-be06-9980bcb81134` |
| Gás  Amoaras | `14d367e5-ff4a-4ad2-bca2-bc46941c2858` |
| IPTU  Amoaras | `e8ec301a-6d17-474e-9750-1a332c7e533a` |
| Impostos | `7f7f60c3-665f-43f2-996f-39fc5de1471f` |
| Internet  Amoaras | `2da01579-1c6a-4102-a254-a7d486192279` |
| Internet Denise | `bc4108ec-1d81-41e5-bcb4-051c65e1731b` |
| Inv. Cassio | `81525468-d004-4966-9920-fa06937af059` |
| LIS | `63413e4d-38e3-48a9-8380-92e2e3f4c4e2` |
| Luz  Amoaras | `76e17f71-9473-4f2e-94a5-2d4d59d6bd18` |
| Manut. SV MarAmor | `8bc020c2-9d9a-45ac-b8d1-10a8bc3b76ae` |
| Pós Cássio | `37824c47-3f0a-4816-918a-43ee187b8637` |
| Queima diária | `00b731f1-dfe7-437e-b928-604c933e3d3a` |
| RECEITA | `64d33f8a-6f32-4c69-80ab-bfd93b698ce8` |
| Salario Baba | `d4c7c3ca-b5e5-41e0-9533-9711d87cc512` |
| Saúde | `8a825c19-c503-4d8d-99ce-d0e39a2c34cd` |
| Seguro  Amoaras | `f203814d-29df-4928-9cd3-28bb89848101` |
| TV  Amoaras | `5e71cd6a-5791-4b3c-a903-1163ce6cccf3` |
| Transferência | `db9fa9e0-99d7-46d5-921d-d837bdb1619c` |
| Transp. Público | `89a61e66-6cfb-48c3-b546-3f6cace5d694` |
| VARIÁVEL | `3a59b4e0-c16a-4e56-ba90-a36fdaf61eee` |
| VIAGEM | `acedb7f5-52e4-49d7-9b07-0ec680d3a21c` |
| Vestuário | `26778e59-4faa-4d8e-994b-ed5df3cb7a73` |
